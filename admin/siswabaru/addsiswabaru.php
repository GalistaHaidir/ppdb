...
if (isset($_POST['simpan'])) {
    ...
    if ($nisn && $nama_siswa && $absen && $nama_kelas) {
        $sql1 = "INSERT INTO siswa_baru (nisn, nama_siswa ,absen, nama_kelas )  
        VALUES ('$nisn','$nama_siswa', '$absen', '$nama_kelas')";
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="col-md my-4 mx-2">
                    <h3 class="fw-bold text-uppercase"><i class="bi bi-person-arms-up"></i>&nbsp;Tambah Siswa Baru
                    </h3>
                </div>
                <hr>
