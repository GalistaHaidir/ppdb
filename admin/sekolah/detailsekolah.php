    ...
    <div class="main-container d-flex">
        ...
        <div class="content">
            ...
            <div class="container" id="cetak">
                ...
                <div class="col-md my-2 mx-2">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <label class="col-sm-2 col-form-label"><strong>NPSN Asal Sekolah</strong></label>
                            <div class="col-sm-10">
                        ...
                        <div class="row">
                            <label class="col-sm-2 col-form-label"><strong>Nama Asal Sekolah</strong></label>
                            <div class="col-sm-10">
                                <input type="text" readonly class="form-control-plaintext form-control-md w-100"
                        ...
                        <div class="row">
                            <label class="col-sm-2 col-form-label"><strong>Alamat Asal Sekolah</strong></label>
                            <div class="col-sm-10">
                                <input type="text" readonly class="form-control-plaintext form-control-md w-100"
                        ...
                        <div class="row">
                            <label class="col-sm-2 col-form-label"><strong>Telepon Asal Sekolah</strong></label>
                            <div class="col-sm-10">
                                <input type="text" readonly class="form-control-plaintext form-control-md w-100"
                                    value=": <?php echo $telepon_sekolah ?>">
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="col-md my-2 mx-4">
                <hr>
                <a href="datasekolah.php" class="btn btn-secondary"><i class="bi bi-arrow-left-circle"></i>&nbsp;Kembali
                </a> |
