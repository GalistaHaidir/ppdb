            ...
            <div class="container">
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <a href="addkelas.php" class="btn btn-primary mb-3"><i class="bi bi-clipboard2-plus"></i>&nbsp;Tambah Kelas</a>
                        <table id="example" class="display nowrap" style="max-width: 95%;">
                            ...
                            <tbody>
                                ...
                                while ($r2 = mysqli_fetch_array($q2)) {
                                    ...
                                    $telepon_walas = $r2['telepon_walas'];
                                    $jumlah_siswa = $r2['jumlah_siswa'];
                                    ?>
                                    <tr>
                                        <th scope="row">
                                            <?php echo $urut++ ?>
                                        ...
                                        <td scope="row">
                                            <?php echo $telepon_walas ?>
                                        </td>
                                        <td scope="row">
                                            <?php echo $jumlah_siswa ?>
                                        </td>
                                        <td scope="row">
                                            <a href="editkelas.php?op=edit&id_kelas=<?php echo $id_kelas ?>"
                                                class="btn btn-warning btn-sm" style="font-weight: 600;"><i
                                                    class="bi bi-pen"></i>&nbsp;Edit
                                            </a> |
                                            <a href="datakelas.php?op=delete&id_kelas=<?php echo $id_kelas ?>"
