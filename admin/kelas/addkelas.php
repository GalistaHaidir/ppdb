...
if (isset($_POST['simpan'])) {
    ...
    if ($nama_kelas && $wali_kelas && $telepon_walas && $jumlah_siswa) {
        $sql1 = "INSERT INTO kelas (nama_kelas, wali_kelas ,telepon_walas, jumlah_siswa )  
        VALUES ('$nama_kelas','$wali_kelas', '$telepon_walas', '$jumlah_siswa')";
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="col-md my-4 mx-2">
                    <h3 class="fw-bold text-uppercase"><i class="bi bi-door-open"></i>&nbsp;Tambah Kelas
                    </h3>
                </div>
                <hr>
