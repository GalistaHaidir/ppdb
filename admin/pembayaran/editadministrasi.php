...
if (isset($_GET['id_daftarulang'])) {
    $id_daftarulang = $_GET['id_daftarulang'];

    // Query SQL untuk mengambil data siswa berdasarkan id_daftarulang
    $query = "SELECT * FROM daftar_ulang WHERE id_daftarulang = $id_daftarulang";
    ...
    if ($result) {
        ...
        if ($row) {
            $id_daftarulang = $row['id_daftarulang'];
...
if (isset($_POST['simpan'])) {
    ...
    if ($id_daftarulang && $id_pendaftaran && $nisn && $tanggal && $jenis_bayar && $keterangan) {
        $sql1 = "UPDATE daftar_ulang SET id_daftarulang = '$id_daftarulang', id_pendaftaran = '$id_pendaftaran', nisn = '$nisn', tanggal = '$tanggal', jenis_bayar = '$jenis_bayar', keterangan = '$keterangan' WHERE id_daftarulang = $id_daftarulang";
